    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/mihir/Downloads/cloud-based-attendance-system-main/Attendance/Manually Attendance/OOP_2019_02_22_Time_11_32_41.csv'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\mihir\Downloads\cloud-based-attendance-system-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier('C:/Users/mihir/Downloads/cloud-based-attendance-system-main/haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("C:/Users/mihir/Downloads/cloud-based-attendance-system-main/TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray[y:y + h, x:x + w])
            ...
            with open('C:/Users/mihir/Downloads/cloud-based-attendance-system-main/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read("C:/Users/mihir/Downloads/cloud-based-attendance-system-main/TrainingImageLabel/Trainner.yml")
                except:
                    e = 'Model not found,Please train model'
                    Notifica.configure(text=e, bg="red", fg="black", width=33, font=('times', 15, 'bold'))
                    Notifica.place(x=20, y=250)

                harcascadePath = "C:/Users/mihir/Downloads/cloud-based-attendance-system-main/haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath)
                df = pd.read_csv("C:/Users/mihir/Downloads/cloud-based-attendance-system-main/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='snow')
                cs = 'C:/Users/mihir/Downloads/cloud-based-attendance-system-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\mihir\Downloads\cloud-based-attendance-system-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'kushal' :
            if password == 'kushal14320':
                ...
                cs = 'C:/Users/mihir/Downloads/cloud-based-attendance-system-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    try:
        recognizer.save("C:/Users/mihir/Downloads/cloud-based-attendance-system-main/TrainingImageLabel/Trainner.yml")
    except Exception as e:
